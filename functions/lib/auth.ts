...
export async function getUser(request: Request, env: Env) {
  ...
  return user as { id: string; name: string; email: string; password_hash: string; plan: string; plan_expires_at: string | null; is_admin: number; free_seconds_used: number } | null
}
